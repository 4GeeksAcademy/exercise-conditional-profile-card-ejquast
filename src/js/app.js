...
function render(variables = {}) {
  ...
  let twitterVariable = "https://www.twitter.com/" + `${variables.twitter}`;
  let githubVariable = "https://wwww.github.com/" + `${variables.github}`;
  let linkedinVariable = "https://wwww.linkedin.com/" + `${variables.linkedin}`;
  let instagramVariable =
    "https://wwww.instagram.com/" + `${variables.instagram}`;
